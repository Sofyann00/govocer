        ...
        <Tabs defaultValue="orders" className="space-y-6">
          ...
          <TabsContent value="orders" className="space-y-4">
            {orders.length === 0 ? (
              ...
              orders.map((order) => (
                <Card key={order.id} className="bg-white/90 backdrop-blur-sm border-gray-200/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
